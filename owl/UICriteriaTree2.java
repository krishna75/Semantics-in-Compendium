 ...
 * It is used in Goals vs Criteria matrix.
 * It updates GCMatrix2 with the selected criteria.
 *
 * @author Krishna Sapkota
 */
public class UICriteriaTree2 extends UIDialog implements TreeSelectionListener , ActionListener{
    ...
    private static GCMatrix2               gcMatrix2;
 ...
 */
    public UICriteriaTree2(JFrame parent, GCMatrix2 gcMatrix2) {
        super(parent,false);
        this.gcMatrix2 = gcMatrix2;

        setLayout(new BorderLayout());
        setLocationRelativeTo(this);
        setTitle("Criteria selection dialog");
    ...
    private void addNorth(){
        ...
        Label labelTree= new Label("Please choose a criterian from the list below");
    ...
    * @param gcMatrix2  will be updated with the newly selected criteria.
...
//      Close the dialog
     ...
     public void addCriteria(DefaultMutableTreeNode node){
        ...
        if (respAdd== JOptionPane.YES_OPTION) {
            gcMatrix2.addDataRow(node.toString());
